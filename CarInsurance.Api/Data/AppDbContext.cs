...
public static class SeedData
{
    public static void EnsureSeeded(AppDbContext db)
    {
        ...
        db.Policies.AddRange(
			...
			// Task A, step 2: Update seed data so all policies have a valid `EndDate`.
			new InsurancePolicy { CarId = car1.Id, Provider = "Groupama", StartDate = new DateOnly(2025,1,1), EndDate = new DateOnly(2023,10,8) }, // open-ended on purpose
